      ...
      <div className="max-w-[935.642px] mx-auto">
        ...
        <div className="flex flex-col items-center gap-8 md:gap-12">
          ...
          <motion.p
            ...
            style={{ fontFamily: 'var(--font-instrument)', textShadow: '0px 2px 6px rgba(0, 0, 0, 0.3)' }}
            initial={{ opacity: 0 }}
            ...
            {socials.map((social, index) => {
              ...
              return (
                <motion.a
                  ...
                  className="group flex items-center gap-4 bg-white/20 backdrop-blur-md px-6 py-4 rounded-2xl border-2 border-white/30 hover:bg-white/30 hover:border-white/50 transition-all duration-300 w-full sm:w-auto min-w-[250px] shadow-lg"
